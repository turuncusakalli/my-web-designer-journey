...
console.log(url.includes('.com')); // true false değeri dönderir

// url string ifadesini geçerli bir url olarak düzenleyiniz.

console.log(url.toLowerCase()
               .replace(/ /g,'-') // bir önceki öğrendiğimiz yöntem sadece ilk elemanda değişiklik
               // yapıyor. burada ise iki slaş işareti arasındaki elemanı her yerde - ile değiştirdi.
               .replace(/ı/g,'i')
               .replace(/ü/g,'u')
               .replace(/ö/g,'o')
               .replace(/ş/g,'s')
